  ...
  return (
    <Wrapper className='section-center'>
      <article className='content'>
        ...
        <p>
          Get Up To 60% Off On Furniture Products With Home Centre Big Freedom
          Sale. Shop Now! Avail 5% Cashback On Select Credit Card On Minimum
          Purchase Of Rs. 5000.
        </p>
